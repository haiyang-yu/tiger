...
public class RsaUtil {
    ...
    public static Pair<RSAPublicKey, RSAPrivateKey> genKeyPair(int rsaKeySize) {
        try {
            ...
            log.error("Generator key pair ex", e);
        }
        return null;
    }
    ...
    public static RSAPublicKey getPublicKey(String modulus, String exponent) {
        try {
            ...
            log.error("getPublicKey ex, modulus={}, exponent={}", modulus, exponent, e);
    ...
    public static RSAPrivateKey getPrivateKey(String modulus, String exponent) {
        try {
            ...
            log.error("getPrivateKey ex, modulus={}, exponent={}", modulus, exponent, e);
    ...
    public static byte[] encryptByPublicKey(byte[] data, RSAPublicKey publicKey) {
        try {
            ...
            log.error("Encrypt by publicKey ex", e);
    ...
    public static byte[] decryptByPrivateKey(byte[] data, RSAPrivateKey privateKey) {
        try {
            ...
            log.error("Decrypt by privateKey ex", e);
